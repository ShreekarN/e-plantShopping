...
const CartItem = ({ onContinueShopping }) => {
  ...
  const parseCost = (costStr) => parseFloat(String(costStr).replace(/[^0-9.-]+/g, '')) || 0;

  const totalItemsCount = cart.reduce((s, it) => s + (it.quantity || 0), 0);
  ...
  return (
    <div className="cart-container">
      <h2 style={{ color: 'black' }}>
        Total Items: {totalItemsCount} — Total Amount: ${calculateTotalAmount()}
      </h2>
      <div>
