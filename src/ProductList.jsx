...
function ProductList({ onHomeClick }) {
  ...
  // total quantity used for the header badge
  ...
  const plantsArray = [
    ...
    },
    {
      ...
      plants: [
        ...
        { name: "Geraniums", image: "https://cdn.pixabay.com/photo/2012/04/26/21/51/flowerpot-43270_1280.jpg", description: "Insect-repelling properties and scent.", cost: "$20" },
        ...
        { name: "Lavender (repellent)", image: "https://images.unsplash.com/photo-1611909023032-2d6b3134ecba?q=80&w=1074", description: "Calming scent, used in aromatherapy.", cost: "$20" },
    ...
    },
    {
      ...
      plants: [
        { name: "Aloe Vera (medicinal)", image: "https://cdn.pixabay.com/photo/2018/04/02/07/42/leaf-3283175_1280.jpg", description: "Soothing gel for skin ailments.", cost: "$14" },
        ...
        { name: "Lemon Balm (medicinal)", image: "https://cdn.pixabay.com/photo/2019/09/16/07/41/balm-4480134_1280.jpg", description: "Calms nerves and promotes relaxation.", cost: "$14" },
    ...
    },
    {
      ...
      plants: [
        { name: "ZZ Plant", image: "https://images.unsplash.com/photo-1632207691143-643e2a9a9361?q=80&w=464", description: "Thrives in low light and requires minimal watering.", cost: "$25" },
        { name: "Pothos", image: "https://cdn.pixabay.com/photo/2018/11/15/10/32/plants-3816945_1280.jpg", description: "Tolerates neglect and grows in various conditions.", cost: "$10" },
        { name: "Snake Plant", image: "https://cdn.pixabay.com/photo/2021/01/22/06/04/snake-plant-5939187_1280.jpg", description: "Needs infrequent watering and is resilient.", cost: "$15" },
        { name: "Cast Iron Plant", image: "https://cdn.pixabay.com/photo/2017/02/16/18/04/cast-iron-plant-2072008_1280.jpg", description: "Hardy plant that tolerates low light.", cost: "$20" },
        { name: "Succulents", image: "https://cdn.pixabay.com/photo/2016/11/21/16/05/cacti-1846147_1280.jpg", description: "Drought-tolerant plants with unique shapes.", cost: "$18" },
        { name: "Aglaonema", image: "https://cdn.pixabay.com/photo/2014/10/10/04/27/aglaonema-482915_1280.jpg", description: "Requires minimal care and adds color.", cost: "$22" }
      ]
    }
  ];
  ...
  return (
    <div>
      <div className="navbar" style={styleObj}>
        <div className="tag" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <a href="/" onClick={handleHomeClick} style={{ textDecoration: 'none', color: 'white' }}>
            <div>
              ...
              <i style={{ color: 'white', fontSize: 12 }}>Where Green Meets Serenity</i>
            </div>
          </a>
        </div>
        ...
        <div style={styleObjUl}>
          ...
          <div style={{ position: 'relative' }}>
            <a href="#" onClick={handleCartClick} style={{ textDecoration: 'none', color: 'white' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" height="36" width="36">
                <rect width="156" height="156" fill="none"></rect>
                <circle cx="80" cy="216" r="12"></circle>
                <circle cx="184" cy="216" r="12"></circle>
                <path d="M42.3,72H221.7l-26.4,92.4A15.9,15.9,0,0,1,179.9,176H84.1a15.9,15.9,0,0,1-15.4-11.6L32.5,37.8A8,8,0,0,0,24.8,32H8" fill="none" stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
              </svg>
            </a>
            {totalQuantity > 0 && (
              <div style={{
